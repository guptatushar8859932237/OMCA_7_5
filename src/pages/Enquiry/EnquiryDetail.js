                    ...
                    <div class="content">
                        <div className="row">
                            <div className="col-md-12">
                                <h4 className="page-title"><span><i class="fi fi-sr-angle-double-small-left" onClick={handleclick} style={{cursor:"pointer"}}></i></span>View Enquiry</h4>
                            </div>
                        </div>
                                ...
                                <div className='row'>
                                    <div className='col-md-12'>
                                        ...
                                        <div className="tab-pane" id="bottom-tab3">
                                            {row.discussionNotes?.length === 0 ? "No notes for patient" : <>
