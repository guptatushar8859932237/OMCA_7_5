        ...
        <>
            <div className="page-wrapper">
                <div className="content">
                    <div className="row">
                        <div className="col-md-12">
                            <h4 className="page-title"><span><i class="fi fi-sr-angle-double-small-left" style={{cursor:"pointer"}} onClick={()=>{window.history.back()}}></i></span>New Enquiry</h4>
                        </div>
                    </div>
                    <div className="main_content">
                        <div className="row">
                                    ...
                                    {({ isSubmitting, setFieldValue }) => (
                                        <Form>
                                            <div className="row">
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="field-set">
                                                        <label>Phone No. / (WhatsAap )<span className="text-danger">*</span></label>
                                                ...
                                                <div className="col-sm-6">
                                                    <div className="field-set">
                                                        <label>Emergency Contact No<span className="text-danger">*</span></label>
                                                        <Field className="form-control" type="text" name="patient_emergency_contact_no" />
