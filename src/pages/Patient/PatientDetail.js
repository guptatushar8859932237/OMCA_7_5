...
import { PainDService } from "../../reducer/PatientsSlice";
  ...
  const handlesubmitdata = async () => {
    ...
    try {
      ...
      if (response.data.success === true) {
        setOpenModal(false);
        toast.success(response.data.message, "Service Data22");
      }
    } catch (error) {
      console.log(error);
    }
    // const response = await dispatch(PainDService(servipostdata))
                ...
                >
                  <div className="field-set">
                    ...
                    <Autocomplete
                      ...
                      onChange={(e, value) => {
                        const selectedCourse = hospital?.find(
