              ...
              <Form>
                <div className="row">
                  ...
                  <div className="col-sm-6">
                    ...
                    <Field className="form-control" name="role" disabled />
                  </div>
                  ...
                  <div className="col-sm-6">
                    ...
                    <div className="gender-select">
                      {["Male", "Female", "Others"].map((gender) => (
                        <label className="form-check-inline" key={gender}>
                    ...
                    <div className="profile-upload">
                      <div className="upload-img">
                        {selectedImage ? (
                          ...
                          <img src={`${image}${editStaff.profileImage}`} alt="Old" />
                        ) : (
...
=======
            <h4 className="page-title"><span><i class="fi fi-sr-angle-double-small-left" onClick={()=>{
                                    window.history.back()
                                }}  style={{cursor:"pointer"}}></i></span>Edit Staff</h4>
          </div>
        </div>
        <div className="main_content">
          <Formik
