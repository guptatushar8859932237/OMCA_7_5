                          ...
                          .map((info, i) => {
                            ...
                            return (
                              <TableRow role="checkbox" tabIndex={-1} key={info.code}>
                                ...
                                <TableCell><img src={`${image}${info.profileImage}`} className="hos-img" alt=""/></TableCell>
                                ...
                                <TableCell  className="action-icon"> 
                                  <i className="fa-solid fa-pen-to-square" onClick={(e) => EditButton(e, info._id)}></i>
                                  <i className="fa-solid fa-trash" onClick={(e) => handledelet(e, info._id)}></i>
                                  </TableCell>
